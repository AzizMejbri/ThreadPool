...
void test_initialization(void) {
    ...
    ThreadPool tp;
    ThreadPool_init(&tp, 4, THREADPOOL_CACHED);
...
void test_single_thread_execution(void) {
    ...
    ThreadPool tp;
    ThreadPool_init(&tp, 1, THREADPOOL_CACHED);
...
void test_multi_thread_execution(void) {
    ...
    ThreadPool tp;
    ThreadPool_init(&tp, 8, THREADPOOL_CACHED);
...
void test_fuzzed_tasks(void) {
    ...
    ThreadPool tp;
    ThreadPool_init(&tp, 6, THREADPOOL_CACHED);
